...
from lib.model.backbone_cnn import ConvBlock
from lib.training.mixup import do_mixup

class ConvPreWavBlock(tf.keras.layers.Layer):
    """
    ...
    def call(self, inputs):
        ...
        Parameters
        ----------
        inputs : (batch_size, data_length, n_channels)
        """
        x = inputs
...
class Wavegram(tf.keras.layers.Layer):
    """
    ...
    def __init__(self):
        ...
        self.pre_block4 = ConvBlock(out_channels=64, pool_size=(1, 2))
